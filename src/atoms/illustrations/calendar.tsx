...
export const Calendar: React.FC<Props> = ({ width = 152, height = 152 }) => (
  ...
  >
    ...
    <path
      d="M68.1632 31.6679C67.0497 28.3725 63.9325 26 60.2613 26C55.6558 26 51.9224 29.7334 51.9224 34.3389C51.9224 38.9443 55.6558 42.6778 60.2613 42.6778"
      stroke="#3B3552"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M92.7777 31.7796C91.6975 28.4262 88.5515 26 84.8389 26C80.2334 26 76.5 29.7334 76.5 34.3389C76.5 38.9443 80.2334 42.6778 84.8389 42.6778"
      stroke="#3B3552"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
